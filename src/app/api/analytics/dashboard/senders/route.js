...
export async function GET(req) {
  try {
    ...
    const backendUrl = `${BACKEND_BASE.replace(/\/$/, '')}/api/analytics/dashboard/senders/${queryString ? `?${queryString}` : ''}`;
    ...
    console.error('Proxy error to backend analytics senders:', err);
